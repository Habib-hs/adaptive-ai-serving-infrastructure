...
import app.generated.inference_pb2 as inference__pb2
...
class ModelInferenceServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                '/inference.v1.ModelInferenceService/Predict',
...
class ModelInferenceServiceServicer:
    """Missing associated documentation comment in .proto file."""
...
def add_ModelInferenceServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'inference.v1.ModelInferenceService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('inference.v1.ModelInferenceService', rpc_method_handlers)
